...
from app.api.v1 import auth, complaints, trains, stations, admin, analytics, notifications, websocket, chat, prototype

api_v1_router = APIRouter()

api_v1_router.include_router(auth.router, prefix="/auth", tags=["Authentication"])
api_v1_router.include_router(complaints.router, prefix="/complaints", tags=["Complaints"])
api_v1_router.include_router(chat.router, prefix="/chat", tags=["AI Chatbot"])
api_v1_router.include_router(prototype.router, prefix="/prototype", tags=["Prototype Operations"])
